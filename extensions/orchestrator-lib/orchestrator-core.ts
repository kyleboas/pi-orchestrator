...
export type PiThinkingLevel = "low" | "medium" | "high" | "xhigh";
...
export type ClaudeCodeWorkerProfile = { backend: "claude-code"; model: string; thinking?: PiThinkingLevel; description?: string; sandbox?: WorkerSandboxOverride };
